          ...
          {users.map((user) => (
            <tr key={user.id} >
              ...
              <td className="flex gap-2 justify-center">
                <button className="text-blue-500 px-3 py-1 hover:bg-blue-500/20 rounded-2xl cursor-pointer">Editar</button>
                <button className="text-red-500 px-3 py-1 hover:bg-red-500/20 rounded-2xl cursor-pointer">Eliminar</button>
              </td>
            </tr>
          ))}
        </tbody>
